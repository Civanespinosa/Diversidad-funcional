...
Esta medida nos permite cuantificar los cambios en la media ponderada de los rasgos y por tanto interpretar como esta media cambia en relación a gradientes ambientales. Veamos cómo implementar esta medida en r. Podemos acceder aquí a los datos de [vegetación](https://github.com/Civanespinosa/Diversidad-funcional/blob/master/parcelas.xlsx), [traits](https://github.com/Civanespinosa/Diversidad-funcional/blob/master/trait.xlsx) y [parcelas](https://github.com/Civanespinosa/Diversidad-funcional/blob/master/parcelas.xlsx)
